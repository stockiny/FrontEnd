export class routes {
  ...
  public static get addCouleur(): string {
    return this.product + '/add-couleur';
  }
  public static get addFournisseur(): string {
    return this.product + '/addFourniseur';
  }
  public static get detailmodel(): string {
    return this.product + '/detailmodel';
  }
  public static get listmodel(): string {
    return this.product + '/list-Model';
  }

  public static get addClient(): string {
    return this.product + '/add-client';
  }
  public static get editClient(): string {
    return this.product + '/edit-client';
  }
  public static get ListClient(): string {
    return this.product + '/clients';
  }

  public static get Fournisseurs(): string {
    return this.product + '/fournisseurs';
  }
  ...
  public static get createDevis(): string {
    return this.product + '/devis';
  }
